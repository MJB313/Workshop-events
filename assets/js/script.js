...
const socialEl1 = document.querySelector(".fa-twitter").style.color="#1DA1F2";
const socialEl2 = document.querySelector(".fa-facebook").style.color="#1877F2";
const socialEl3 = document.querySelector(".fa-instagram").style.color="#e1306c";
